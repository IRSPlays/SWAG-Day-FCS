...
export default function Finale() {
  return (
    <SlideShell className="bg-[#070910]">
      {/* slow-breathing volt glow */}
      <KenBurns className="absolute left-1/2 top-1/2 z-0 h-[900px] w-[1400px] -translate-x-1/2 -translate-y-1/2" duration={24} scale={1.25}>
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center px-24 text-center">
        <p className="font-body text-[24px] font-bold tracking-[0.5em] text-ice/40">
          FINAL WHISTLE
        </p>

        <h2 className="mt-10 max-w-[1500px] font-serifit text-[110px] italic leading-[1.12] text-ice">
          <LetterStagger
            text="“Thank you for coaching us in life.”"
            delay={0.4}
            stagger={0.03}
            duration={0.9}
            from="0.4em"
        ...
        <ClipWipeReveal delay={2.1} from="bottom">
          <p className="mt-12 font-body text-[26px] font-bold tracking-[0.44em] text-volt">
            HAPPY TEACHERS&apos; DAY — FROM ALL OF US
          </p>
        </ClipWipeReveal>
        <ClipWipeReveal delay={2.5} from="bottom">
          <p className="mt-3 font-body text-[20px] font-medium tracking-[0.4em] text-ice/40">
            SWAG DAY &apos;26 · SUIT UP! SHOW UP! SPORT IT UP!
          </p>
        </ClipWipeReveal>
      </div>
    </SlideShell>
